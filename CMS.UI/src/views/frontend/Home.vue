  ...
  <section id="hero">
    ...
    >
      ...
      <button
        ...
        data-bs-slide="prev"
      >
        <span class="carousel-control-prev-icon" aria-hidden="true"><i class="pi pi-chevron-left text-white"></i></span>
      ...
      <button
        ...
        data-bs-slide="next"
      >
        <span class="carousel-control-next-icon" aria-hidden="true"><i class="pi pi-chevron-right text-white"></i></span>
