<template>
  ...
  <div class="row">
    <div class="col-md-8">
      <h4 class="mt-4 mb-4">
        Tiyatro Kooperatifi, 2. Olağan Genel Kurulu’nu gerçekleştirdi
      </h4>
      <img
      ...
      />
      <div class="mt-3 mb-3">
        Mayıs 2018’de 13 özel tiyatronun girişimiyle çalışmalarına başlayan ve
        bugün 64 özel tiyatronun dahil olduğu büyük ve güçlü bir yapı olarak
        yola devam eden Tiyatro Kooperatifi, 6 Nisan 2021 Salı günü 2. Olağan
        Genel Kurulu’nu gerçekleştirdi. Pandemi koşulları gözetilerek DasDas’ın
        açık avlusunda gerçekleştirilen toplantıda, Kasım 2019’dan beri gönüllü
        olarak görev yapan Yönetim Kurulu Başkanı Iraz Yöntem, Başkan Yardımcısı
        Yeşim Özsoy, Yönetim Kurulu Üyeleri Ersin Umut Güler, Mert Fırat ve
        Muharrem Uğurlu Yönetim Kurulu’na yeniden seçilerek bir yıl için daha
        aynı sorumluluğu üstlendi. Tiyatro Kooperatifi, pandemi sürecinde büyük
        yara alan ve kapanma tehlikesiyle karşı karşıya olan özel tiyatrolar
        için acil çözüm çağrısını sürdürüyor. Sektörün ayakta kalmasının ancak
        somut ve sürdürülebilir çözümlerle mümkün olduğunu vurgulayan
        kooperatif, telafisi belki de on yıllar alacak kayıpların yaşanmaması
        için ilgilileri sorumlu davranmaya davet ediyor.
      </div>
    ...
    <div class="col-md-4">
      <div class="card mt-4 mb-4">
        <h5 class="card-header">Çok Okunan Haberler</h5>
        <div class="card-body">
          <div class="mt-4 mb-4">
